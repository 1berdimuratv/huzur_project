...
public class ButtonService {
    ...
    public static ReplyKeyboardMarkup sendLocation() {
        KeyboardRow row1 = new KeyboardRow();
        KeyboardRow row2 = new KeyboardRow();
        KeyboardButton button1 = new KeyboardButton(i18n.getMsg(SHARE_LOCATION));
        ...
        return finalCase(List.of(row1,row2));
    }
    ...
    public static ReplyKeyboardMarkup settings(String name,String number) {
        ...
        KeyboardButton button3 = new KeyboardButton(i18n.getMsg(CHANGE_NUMBER).formatted(number));
        row3.add(button3);
